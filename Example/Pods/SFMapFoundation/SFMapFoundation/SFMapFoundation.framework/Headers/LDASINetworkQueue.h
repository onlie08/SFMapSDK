...
#import "LDASIHTTPRequestDelegate.h"
#import "LDASIProgressDelegate.h"

@interface LDASINetworkQueue : NSOperationQueue <LDASIProgressDelegate, LDASIHTTPRequestDelegate, NSCopying> {
...
// All LDASINetworkQueues are paused when created so that total size can be calculated before the queue starts
